        ...
        <div class="container-info-top">
            <div class="content">
                ...
                <div class="right">
                    ...
                    <img src="{{ assets('/storage/assets/adv-new.png') }}"alt="">
                </div>
            </div>
        </div>
            ...
            <div class="container-main-info-bottom">
                <div class="content-main-info-bottom">
                    <div class="box-one">
                        ...
                        <img src="{{ assets('/storage/assets/icons-1.png') }}" alt="">
                    </div>
                    <div class="box-two">
                        <a href="">
                            shop dc
                        </a>
                        <img src="{{ assets('/storage/assets/icons-4.png') }}" alt="">
                    </div>
                    <div class="box-three">
                        <a href="">
                            comic shop locator
                        </a>
                        <img src="{{ assets('/storage/assets/icons-3.png') }}" alt="">
                    </div>
                    <div class="box-four">
                        <a href="">
                            subscription
                        </a>
                        <img src="{{ assets('/storage/assets/icons-2.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
